...
static const std::unordered_map<std::string, int> keyMap = {
    ...
    {"comma", GLFW_KEY_COMMA}, {"minus", GLFW_KEY_MINUS}, {"period", GLFW_KEY_PERIOD},
    ...
    {"page_up", GLFW_KEY_PAGE_UP}, {"page_down", GLFW_KEY_PAGE_DOWN}, {"home", GLFW_KEY_HOME},
    {"end", GLFW_KEY_END},
    ...
    {"kp_9", GLFW_KEY_KP_9}, {"kp_decimal", GLFW_KEY_KP_DECIMAL}, {"kp_divide", GLFW_KEY_KP_DIVIDE},
    ...
    {"left_alt", GLFW_KEY_LEFT_ALT}, {"left_super", GLFW_KEY_LEFT_SUPER},
    {"right_shift", GLFW_KEY_RIGHT_SHIFT}, {"right_control", GLFW_KEY_RIGHT_CONTROL},
    {"right_alt", GLFW_KEY_RIGHT_ALT}, {"right_super", GLFW_KEY_RIGHT_SUPER},
    {"menu", GLFW_KEY_MENU},
};